...
class FortranAnalyzer:
    ...
    Example:
        ...
        >>> from transjax.analyzer import create_analyzer_for_project
    ...
    def analyze(self, save_results: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            self.call_graph_builder.build_entity_call_graph(modules)
    ...
    def _save_summary_report(self) -> None:
        ...
        with open(report_file, "w") as f:
            f.write("Fortran Codebase Analysis Report\n")
            f.write(f"{'=' * 40}\n\n")
...
def quick_analyze(
    ...
    Example:
        ...
        >>> from transjax.analyzer import quick_analyze

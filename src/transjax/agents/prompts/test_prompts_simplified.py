...
# FEW-SHOT: correct import pattern (package is installed via pip install -e .)
from my_package.my_module import my_function   # real function, NOT a mock
"""
...
1. Imports
   - Import the REAL translated function from {{source_directory}}.{{module_name}}
     (the package is installed via `pip install -e .` — no sys.path manipulation needed)

...
def psim_monin_obukhov(
    ...
    Businger et al. (1971) for unstable conditions and Dyer (1974) for
    stable conditions.
    ...
    Note:
        ...
        The unstable formulation uses the Kansas form with the fourth-root
        relationship. The stable formulation uses a simple linear relationship.
    """
...
def psic_monin_obukhov(zeta: jnp.ndarray) -> jnp.ndarray:
    ...
    Note:
        ...
        - For stable conditions (zeta >= 0), uses linear relationship
